...
This git has been implemented by [fsmosca](https://github.com/fsmosca/Python-Easy-Chess-GUI)
We are three students ([Louis Fontaine](https://github.com/Daugit), Kenza Hammou) working on Monte Carlo optimization. We are building an AI to play chess.
